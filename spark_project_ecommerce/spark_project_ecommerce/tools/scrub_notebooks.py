...
Run from repo root: python spark_project_ecommerce/spark_project_ecommerce/tools/scrub_notebooks.py
"""
...
# Must be a valid Azure storage account name shape (3–24 lower alphanumeric).
